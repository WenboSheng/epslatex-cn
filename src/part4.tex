...
\begin{minipage}{\linewidth}
	...
	\usebox{\boxgraphictwo}
	\captionsetup{labelformat=simple}
	\captionof{figure}{This is Caption Label Example \#1}
...
\begin{minipage}{\linewidth}
	...
	\usebox{\boxgraphictwo}
	\captionsetup{labelformat=parens}
	\captionof{figure}{This is Caption Label Example \#2}
...
\begin{minipage}{\linewidth}
	...
	\usebox{\boxgraphictwo}
	\captionsetup{labelformat=empty, labelsep=none}
	\captionof{figure}{This is Caption Label Example \#3}
...
\begin{minipage}{\linewidth}
	...
	\usebox{\boxgraphictwo}
	\captionsetup{labelformat=default, labelsep=period}
	\captionof{figure}{This is Caption Label Example \#4}
...
\begin{minipage}{\linewidth}
	...
	\usebox{\boxgraphictwo}
	\captionsetup{labelformat=default, labelsep=newline}
	\captionof{figure}{This is Caption Label Example \#5}
	\label{fig:caption-label-ex5}
\end{minipage}

\vskip2em\hrule

\subsubsection{Caption 宏包格式选项}
...
\begin{minipage}{\linewidth}
	...
	\usebox{\boxgraphictwo}
	\captionsetup{width=3in}
	\captionof{figure}{This is an example of customizing the caption width}
...
\begin{minipage}{\linewidth}
	...
	\usebox{\boxgraphictwo}
	\captionsetup{style=BigLeft}
	\captionof{figure}{This Caption uses BigLeft Style}
...
\begin{minipage}{\linewidth}
	...
	\usebox{\boxgraphictwo}
	\captionsetup{font=BigAndBold}
	\captionof{figure}{This Caption uses a Custom Font}
...
\begin{minipage}{\linewidth}
	...
	\usebox{\boxgraphictwo}
	\captionsetup{labelformat=hash}
	\captionof{figure}{This Caption has a Custom Label Format}
...
表~\ref{tab:caption-labelopt} 定义了 \opt{labelsep=} 选项值。
用户可以用 \cmdi{DeclareCaptionLabelSeparator} 命令为 \opt{labelsep=} 选项自定义额外的选项值。
...
\end{lstlisting}
的效果见图~\ref{fig:caption-labelsep-arrow}。

\begin{minipage}{\linewidth}
	\centering
	\usebox{\boxgraphictwo}
	\captionsetup{labelsep=arrow}
	\captionof{figure}{This Caption has a Custom Label Separator}
...
其中 \opt{\#1} 代表标题标签，\opt{\#2} 代表标题分隔符，\opt{\#3} 代表标题文本（其定义可参见图~\ref{fig:captiondef}）。
...
\begin{itemize}
	...
	\item 命令 \cmdO{\cmd{}}{\cmd{intextsep}} 开始新的一行并在图形的前后加上垂直的空白。
